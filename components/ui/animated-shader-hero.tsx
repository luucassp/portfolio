...
// Overlay de conteúdo do hero (badge/headline/subtitle/botões). O fundo
// animado (WebGL shader) é sitewide — ver app/components/ShaderBackground.tsx,
// montado em app/layout.tsx — este componente não desenha mais o próprio
// canvas, só o texto por cima.
interface HeroProps {
  trustBadge?: {
    text: string;
    icons?: string[];
